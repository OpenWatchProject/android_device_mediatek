...
MTK_PTGEN_PERL := device/mediatek/build/build/tools/ptgen/$(MTK_PTGEN_CHIP)/ptgen_nand_old.pl
endif
endif
endif
...
MTK_PTGEN_COMMAND := \
	...
	MTK_HALF_NAND_SUPPORT=${MTK_HALF_NAND_SUPPORT} \
...
MTK_VENDOR_IMAGE_NAMES += loader_ext.img
MTK_OTA_UPDATE_LIST += loader_ext.img:loader_ext1:loader_ext2
endif
ifdef LK_PROJECT
