...
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    ...
    ifeq ($(strip $(MTK_GMO_RAM_OPTIMIZE)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6757/media_profiles_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
    else
...
PRODUCT_PACKAGES += powercontable_t.xml
...
PRODUCT_PACKAGES += fstab.mt6757.ramdisk
...
ifeq (yes,$(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)))
    ...
    ifeq ($(strip $(MTK_GMO_RAM_OPTIMIZE)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_mediatek_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
        PRODUCT_COPY_FILES += device/mediatek/mt6757/mtk_omx_core_gmo.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
    else
...
ifeq ($(strip $(MTK_GMO_RAM_OPTIMIZE)), yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_c2_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
else
    PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_c2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
endif
