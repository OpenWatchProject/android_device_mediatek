...
#Force setting vendor parition for MT6757
...
BOARD_RAMDISK_OFFSET = 0x12000000
BOARD_TAGS_OFFSET = 0x13000000
...
# config.fs
TARGET_FS_CONFIG_GEN += device/mediatek/mt6757/config.fs
...
PRODUCT_CUSTOM_IMAGE_MAKEFILES += device/mediatek/mt6757/odm/odm.mk
endif
endif
