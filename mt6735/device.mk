...
PRODUCT_PACKAGES += fstab.mt6735.ramdisk
...
ifeq ($(strip $(MTK_GLOBAL_PQ_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.vendor.globalpq.support=1
endif
...
ifeq ($(strip $(RAT_CONFIG_C2K_SUPPORT)),yes)
ifeq ($(strip $(LINUX_KERNEL_VERSION)),kernel-3.18)
PRODUCT_COPY_FILES += device/mediatek/mt6735/factory_init.c2k.usb.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.usb.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6735/factory_init.c2k.usb.configfs.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.usb.rc
endif
else
ifeq ($(strip $(LINUX_KERNEL_VERSION)),kernel-3.18)
PRODUCT_COPY_FILES += device/mediatek/mt6735/factory_init.usb.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.usb.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6735/factory_init.usb.configfs.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.usb.rc
endif
endif
...
ifeq ($(strip $(LINUX_KERNEL_VERSION)),kernel-3.18)
PRODUCT_COPY_FILES += device/mediatek/mt6735/meta_init.usb.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.usb.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6735/meta_init.usb.configfs.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.usb.rc
endif
ifeq ($(strip $(LINUX_KERNEL_VERSION)),kernel-3.18)
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.mt6735.usb.rc:$(MTK_TARGET_VENDOR_RC)/init.mt6735.usb.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.mt6735.usb.configfs.rc:$(MTK_TARGET_VENDOR_RC)/init.mt6735.usb.rc
endif
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.recovery.mt6735.rc:recovery/root/init.recovery.mt6735.rc
ifeq ($(strip $(LINUX_KERNEL_VERSION)),kernel-3.18)
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.recovery.mt6735.usb.rc:recovery/root/init.recovery.mt6735.usb.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.recovery.mt6735.usb.configfs.rc:recovery/root/init.recovery.mt6735.usb.rc
endif
...
ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        ...
        ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
            PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_audio_phone_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
        else
...
ifeq (yes 0x20000000,$(strip $(MTK_GMO_RAM_OPTIMIZE)) $(strip $(CUSTOM_CONFIG_MAX_DRAM_SIZE)))
  ...
  ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6735/mtk_omx_core_gmo_tablet.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
  else
  ...
  ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6735/mtk_omx_core_tablet.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
  else
...
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_c2_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
else
