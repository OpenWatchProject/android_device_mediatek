...
ifeq ($(strip $(MTK_RC_TO_VENDOR)), yes)
  ...
  ifeq ($(strip $(MTK_EMMC_SUPPORT)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6761/ueventd.mt6761.emmc.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
  else ifeq ($(strip $(MTK_UFS_BOOTING)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6761/ueventd.mt6761.ufs.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
  endif
else
  MTK_TARGET_VENDOR_RC = root
  PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.vendor.rc=/
  ifeq ($(strip $(MTK_EMMC_SUPPORT)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6761/ueventd.mt6761.emmc.rc:root/ueventd.mt6761.rc
  else ifeq ($(strip $(MTK_UFS_BOOTING)),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6761/ueventd.mt6761.ufs.rc:root/ueventd.mt6761.rc
  endif
endif
...
PRODUCT_PACKAGES += consumerir.mt6761
else
# IRTX over PWM
...
PRODUCT_PACKAGES += sound_trigger.primary.mt6761
...
PRODUCT_PACKAGES += thermal.mt6761
...
PRODUCT_PACKAGES += memtrack.mt6761
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
    PRODUCT_PACKAGES += gralloc.mt6761
...
PRODUCT_COPY_FILES += device/mediatek/mt6761/init.sensor_1_0.rc:$(MTK_TARGET_VENDOR_RC)/init.sensor_1_0.rc
endif
PRODUCT_COPY_FILES += device/mediatek/mt6761/meta_init.modem.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.modem.rc
ifneq ($(strip $(PLATFORM_VERSION)),R)
PRODUCT_COPY_FILES += device/mediatek/mt6761/meta_init.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6761/meta_init_r.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.rc
endif
...
ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
            PRODUCT_COPY_FILES += device/mediatek/mt6761/media_codecs_mediatek_audio_tablet_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
        else
        ...
        ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
            PRODUCT_COPY_FILES += device/mediatek/mt6761/media_codecs_mediatek_audio_phone_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
        else
...
ifeq (yes,$(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)))
    ...
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
            PRODUCT_COPY_FILES += device/mediatek/mt6761/mtk_omx_core_tablet_gmo.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
        else
...
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
PRODUCT_COPY_FILES += device/mediatek/mt6761/media_codecs_google_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_video_le.xml
PRODUCT_COPY_FILES += device/mediatek/mt6761/media_codecs_c2_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
else
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt6761/audio_device_param/DSM_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/DSM_config.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6761/audio_device_param/DSM.xml:$(TARGET_COPY_OUT_VENDOR)/etc/DSM.xml:mtk
