# mt6761 platform boardconfig

# Use the common part
include device/mediatek/vendor/common/BoardConfig.mk

# Use the non-open-source part, if present
-include vendor/mediatek/mt6761/BoardConfigVendor.mk

#Force setting vendor parition for MT6761
...
BOARD_SEPOLICY_DIRS += \
        device/mediatek/mt6761/sepolicy/basic
endif
ifeq ($(strip $(MTK_BSP_PACKAGE)), yes)
BOARD_SEPOLICY_DIRS += \
        device/mediatek/mt6761/sepolicy/basic \
        device/mediatek/mt6761/sepolicy/bsp
endif
...
BOARD_SEPOLICY_DIRS += \
        device/mediatek/mt6761/sepolicy/basic \
        device/mediatek/mt6761/sepolicy/bsp \
        device/mediatek/mt6761/sepolicy/full
endif
endif
...
# Create product partition
TARGET_COPY_OUT_PRODUCT := product
BOARD_PRODUCTIMAGE_FILE_SYSTEM_TYPE := ext4

# Create odm partition and Generate separate odm.img
# TARGET_COPY_OUT_ODM := odm is set in BoardConfig.mk under common level folder
ifeq ($(strip $(TARGET_COPY_OUT_ODM)),odm)
BOARD_ODMIMAGE_FILE_SYSTEM_TYPE := ext4
endif

# add product to vbmeta_system partitions
# add odm to vbmeta_vendor partition
...
PRODUCT_CUSTOM_IMAGE_MAKEFILES += device/mediatek/mt6761/odm/odm.mk
endif
endif
