SYS_TARGET_PROJECT := mssi_t_32_ago_ww_armv7_datasms
SYS_BASE_PROJECT := mssi_t_32_ago_ww_armv7_datasms
...
PRODUCT_NAME := sys_mssi_t_32_ago_ww_armv7_datasms
PRODUCT_DEVICE := $(strip $(SYS_BASE_PROJECT))
PRODUCT_MODEL := mssi_t_32_ago_ww_armv7_datasms
