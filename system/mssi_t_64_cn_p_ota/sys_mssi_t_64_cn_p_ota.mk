SYS_TARGET_PROJECT := mssi_t_64_cn_p_ota
SYS_BASE_PROJECT := mssi_t_64_cn_p_ota
...
PRODUCT_NAME := sys_mssi_t_64_cn_p_ota
PRODUCT_DEVICE := $(strip $(SYS_BASE_PROJECT))
PRODUCT_MODEL := mssi_t_64_cn_p_ota
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps
PRODUCT_SHIPPING_API_LEVEL := 28
MSSI_PRODUCT_SHIPPING_API_LEVEL_OVERRIDE := $(PRODUCT_SHIPPING_API_LEVEL)
