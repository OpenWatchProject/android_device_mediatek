...
PRODUCT_PACKAGES += fstab.mt6763.ramdisk
...
ifeq (yes,$(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)))
    ...
    ifeq ($(strip $(MTK_GMO_ROM_OPTIMIZE)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6763/media_codecs_mediatek_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
    else
...
PRODUCT_COPY_FILES += device/mediatek/mt6763/media_codecs_c2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
...
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6763/media_profiles_ducam.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
else
    ifeq ($(strip $(MTK_GMO_ROM_OPTIMIZE)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6763/media_profiles_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6763/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
    endif
endif
...
ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
    MTK_AUDIO_PARAM_DIR_LIST += device/mediatek/mt6763/audio_param
...
PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mediatek.platform=MT6763
